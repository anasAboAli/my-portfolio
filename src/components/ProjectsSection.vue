...
const projects = ref([
  {
    ...
    description: 'A web application that showcases the latest mobile phones, pricing, and current store offers.',
...
.project-card {
    ...
    &__description {
        background-color: #112240; // slightly distinct or just plain
        color: var(--text-main);
        font-size: 1rem;
        border-radius: 4px;
        margin-bottom: 20px;
